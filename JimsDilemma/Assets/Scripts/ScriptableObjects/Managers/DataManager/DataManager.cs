...
//	public List<string> slotListItemNames = new List<string>();
    ...
    //[Header("DELETEALLDATA[SWITCHOFFAFTER]")]
    //[SerializeField] private bool DELETE_ALL_DATA;

	[Header("PlayerData_Reference")]
	public PlayerDataCollection playerData;


    [Header("Scene_References")]
    public StringVariable currentSceneName;
    public BoolVariable isStartUIOn;
    public BoolVariable isSceneLoading;
    public BoolVariable isStressMenuOn;
    public BoolVariable isGameSuccess;
    // public IntVariable playerPoints;

    // [Header("PlayerData_References")]

    // public InventoryList masterPlayerInventory;
    //   public TaskList masterTaskList;
    // public CopingMechanismsList masterCopingMechList;

    // public PointsList masterPlayerPoints;
    //public ResiliencyData playerResiliency;
    ...
    //[Header("Scriptable_Objects_To_Persist_For_Builds")]
    //public List<ScriptableObject> sObjectsToPersist;

    //public void SaveData()
    //{
    //    for (int i = 0; i < sObjectsToPersist.Count; i++)
    //    {
    ...
    //            JsonUtility.FromJsonOverwrite((string)bf.Deserialize(file), sObjectsToPersist[i]);
    //            file.Close();

    //            Debug.Log(sObjectsToPersist[i].name);
    //        }
    //        else
    //        {
    //            //DO NOTHING
    ...
    //        var json = JsonUtility.ToJson(sObjectsToPersist[i]);
    ...
    */
    ...
    //      playerData.savedPlayerPosition = playerData.homePlayerPosition;
    ...
    //   //   playerData.slotListItemNames.Clear();
    //     // List<GameObject> temp = new List<GameObject>();
    //      //SaveItemList(temp);

    //      //Are we leaving task to PlayerPrefs or to be determined by scriptable object
    //     // DeletePPDataTaskProgress ();

    //      foreach (var task in playerData.masterTaskList.Items)
    //      {
    //          task.taskStatus = Task_Status.NOT_IDENTIFIED;
    //      }
    //      foreach (var item in playerData.masterInventoryList.Items)
    //      {
    //          item.isPlayerCarrying = false;
    //          item.isRemoveFromGame = false;
    //      }
    ...
    //	string OutputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"curTaskStatus.json";
    ...
    //       string OutputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json";// "currentItems.json";
    ...
    //string InputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"currentItems.json";
    //	Debug.Log (InputPath);
    ...
    //		//DeletePlayerTaskData ();
    //		string InputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"curTaskStatus.json";
    //		Debug.Log (InputPath);
    //		StreamReader Reader = new StreamReader (InputPath);
    //		string JSonString = Reader.ReadToEnd ();
    //		Debug.Log ("Reading:" + JSonString);
    ...
    //string OutputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"playerpos.json";
    ...
    //string InputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"playerpos.json";
    //	Debug.Log (InputPath);
    //	StreamReader Reader = new StreamReader (InputPath);
    //	string JSonString = Reader.ReadToEnd ();
    //	Debug.Log ("Reading:" + JSonString);
    ...
    //string OutputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"stressLevel.json";

    //	playerData.playerResilienceHealth.resilienceHealth = (int) stressAmount;
    ...
    //string InputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"stressLevel.json";
    //	Debug.Log (InputPath);
    //	StreamReader Reader = new StreamReader (InputPath);
    //	string JSonString = Reader.ReadToEnd ();
    //	Debug.Log ("Reading:" + JSonString);
    ...
    //	stressAmount = playerData.playerResilienceHealth.resilienceHealth;
    ...
    //	string OutputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"copingMech.json";
    ...
    //	string InputPath = Application.persistentDataPath + "/" + playerData.name + "_playerData.json"; //"copingMech.json";
    //	Debug.Log (InputPath);
    //	StreamReader Reader = new StreamReader (InputPath);
    //	string JSonString = Reader.ReadToEnd ();
    //	Debug.Log ("Reading:" + JSonString);
    ...
    //string Path = "/" + playerData.name + curScene + "_score.json";
    ...
    //	string Path = "/" + playerData.name + sceneToLoad + "_score.json";
    ...
    //public void CheckHighScore(Points pointsToCheckAgainst)
    //{
    //    if(playerData.masterPlayerPoints.currentPlayerPoints.Value >)
    //    if (playerPoints.Value > pointsToCheckAgainst.Value)
    //    {
