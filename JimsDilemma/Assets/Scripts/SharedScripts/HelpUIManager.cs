...
public enum Goal{CONTINUE_TEXT_BUTTON, OPENMENU, CLICK_COPING, WALK, JUMP, CLICK_ACTION,CLICK_INFORMATION, WAITEXPLANATION,WAITFORTIMELINE, NONE};
public class HelpUIManager : MonoBehaviour {
    ...
    public bool isContinueButtonPressed = false;
